...
typedef struct
{
	uint32_t SPI_Mode;		  /*!> ModeValues for SPI @def_group Mode_Values  */
	uint32_t SPI_CPHA;	      /*!> CPHA Values for SPI @def_group CPHA_Values*/
	uint32_t SPI_CPOL;		  /*!> CPOL Values for SPI @def_group CPOL_Values*/
	uint32_t SPI_BaudRate;    /*!< BaudRate Values for SPI @def_group SPI BaudRates*/
